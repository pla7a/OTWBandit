...
bandit12@melinda:~$ ls
data.txt
bandit12@melinda:~$ mkdir /tmp/myDir1
bandit12@melinda:~$ cp data.txt /tmp/myDir1
bandit12@melinda:~$ cd /tmp/myDir1
bandit12@melinda:/tmp/myDir1$ file data.txt
data.txt: ASCII text
bandit12@melinda:/tmp/myDir1$ cat data.txt
...
bandit12@melinda:/tmp/myDir1$ xxd -r data.txt > data1
bandit12@melinda:/tmp/myDir1$ file data1
data1: gzip compressed data, was "data2.bin", from Unix, last modified: Fri Nov 14 10:32:20 2014, max compression
bandit12@melinda:/tmp/myDir1$ mv data1 data1.gz
bandit12@melinda:/tmp/myDir1$ gzip -d data1.gz
bandit12@melinda:/tmp/myDir1$ file data1
data1: bzip2 compressed data, block size = 900k
bandit12@melinda:/tmp/myDir1$ mv data1 data1.bz2
bandit12@melinda:/tmp/myDir1$ bzip2 -d data1.bz2
bandit12@melinda:/tmp/myDir1$ file data1
data1: gzip compressed data, was "data4.bin", from Unix, last modified: Fri Nov 14 10:32:20 2014, max compression
bandit12@melinda:/tmp/myDir1$ mv data1 data1.gz
bandit12@melinda:/tmp/myDir1$ gzip -d data1.gz
bandit12@melinda:/tmp/myDir1$ file data1
data1: POSIX tar archive (GNU)
bandit12@melinda:/tmp/myDir1$ mv data1 data1.tar
bandit12@melinda:/tmp/myDir1$ tar xvf data1.tar
data5.bin
bandit12@melinda:/tmp/myDir1$ file data5.bin
data5.bin: POSIX tar archive (GNU)
bandit12@melinda:/tmp/myDir1$ mv data5.bin data5.tar
bandit12@melinda:/tmp/myDir1$ tar xvf data5.tar
data6.bin
bandit12@melinda:/tmp/myDir1$ file data6.bin
data6.bin: bzip2 compressed data, block size = 900k
bandit12@melinda:/tmp/myDir1$ mv data6.bin data6.bz2
bandit12@melinda:/tmp/myDir1$ bzip2 -d data6.bz2
bandit12@melinda:/tmp/myDir1$ file data6
data6: POSIX tar archive (GNU)
bandit12@melinda:/tmp/myDir1$ mv data6 data6.tar
bandit12@melinda:/tmp/myDir1$ tar xvf data6.tar
data8.bin
bandit12@melinda:/tmp/myDir1$ file data8.bin
data8.bin: gzip compressed data, was "data9.bin", from Unix, last modified: Fri Nov 14 10:32:20 2014, max compression
bandit12@melinda:/tmp/myDir1$ mv data8.bin data8.gz
bandit12@melinda:/tmp/myDir1$ gzip -d data8.gz
bandit12@melinda:/tmp/myDir1$ file data8   
data8: ASCII text
bandit12@melinda:/tmp/myDir1$ cat data8
