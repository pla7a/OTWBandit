...
Getting into bandit17:
```
[plaza@plaza OTW]$ echo '-----BEGIN RSA PRIVATE KEY-----
...
> -----END RSA PRIVATE KEY-----
> ' > ssh.key
[plaza@plaza OTW]$ ssh -i ssh.key bandit17@bandit.labs.overthewire.org
...
[plaza@plaza OTW]$ chmod 400 ssh.key
[plaza@plaza OTW]$ ssh -i ssh.key bandit17@bandit.labs.overthewire.org
